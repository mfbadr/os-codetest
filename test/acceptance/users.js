...
process.env.DB   = 'mongodb://localhost/os-codetest-test';

var expect  = require('chai').expect,
    cp      = require('child_process'),
    app     = require('../../server/index'),
    dbConnect = require('../../server/lib/mongodb'),
    db        = 'mongodb://localhost/os-codetest-test',
    cookie  = null,
...
describe('users', function(){
  ...
  beforeEach(function(done){
    cp.execFile(__dirname + '/../scripts/clean-db.sh', ['os-codetest-test'], {cwd:__dirname + '/../scripts'}, function(err, stdout, stderr){
      request(app)
      .post('/login')
